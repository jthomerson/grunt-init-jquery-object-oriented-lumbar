/**
 * grunt-init-jquery-object-oriented-lumbar
 * https://github.com/jthomerson/grunt-init-jquery-object-oriented-lumbar
 * https://gruntjs.com/
 *
 * Copyright (c) 2013 Jeremy Thomerson
...
exports.description = 'Create a jQuery plugin that uses object-oriented code and Lumbar, including QUnit unit tests.';
...
exports.template = function(grunt, init, done) {
  ...
  init.process({type: 'jquery'}, [
    ...
    init.prompt('name', 'awesomeness'),
    init.prompt('primary_class_name', 'Awesomeizer'),
